...
<html>
    ...
    <body>
      <header>
        ...
        {
             out.println((String)session.getAttribute("delete"));
      ...
      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/emart","root","");
       ...
       while(rs.next())
       {
           ...
           <tr>
               ...
               <td><a href="view.jsp?id=<%=rs.getInt("id")%>">View</a> | <a href="update.jsp?id=<%=rs.getInt("id")%>">Update</a> | <a href="delete.jsp?id=<%=rs.getInt("id")%>">Delete</a></td>
           </tr>   
           <%
           i++;
       }
